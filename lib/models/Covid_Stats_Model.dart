/// updated : 1681831716024
/// cases : 685765468
/// todayCases : 39725
/// deaths : 6843069
/// todayDeaths : 120
/// recovered : 658505412
/// todayRecovered : 34949
/// active : 20416987
/// critical : 39571
/// casesPerOneMillion : 87977
/// deathsPerOneMillion : 877.9
/// tests : 6971480090
/// testsPerOneMillion : 877474.77
/// population : 7944935131
/// oneCasePerPeople : 0
/// oneDeathPerPeople : 0
/// oneTestPerPeople : 0
/// activePerOneMillion : 2569.81
/// recoveredPerOneMillion : 82883.67
...
class CovidStatsModel {
  ...
  CovidStatsModel.fromJson(dynamic json) {
...
CovidStatsModel copyWith({  num? updated,
  num? cases,
  num? todayCases,
  num? deaths,
  num? todayDeaths,
  ...
  num? criticalPerOneMillion,
  num? affectedCountries,
}) => CovidStatsModel(  updated: updated ?? _updated,
  cases: cases ?? _cases,
